...
namespace Property
{
	...
	class Dock : public Gwen::ControlFactory::Property 
	{
		...
		UnicodeString GetValue( Controls::Base* ctrl )
		{
			switch( ctrl->GetDock() )
			{
				case Pos::Left: return GWEN_T("Left");
				case Pos::Fill: return GWEN_T("Fill");
				case Pos::Right: return GWEN_T("Right");
				case Pos::Top: return GWEN_T("Top");
				case Pos::Bottom: return GWEN_T("Bottom");
			}
